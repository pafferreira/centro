        ...
        <div className="relative flex min-h-screen w-full flex-col items-center justify-center p-6 overflow-hidden text-white">
            ...
            <div className="relative w-full flex flex-col items-center mb-6 z-10">
                <div className="mb-4 drop-shadow-2xl">
                    <img src={logo} alt="GFA Logo" className="w-32 h-32 object-contain drop-shadow-[0_10px_30px_rgba(255,255,255,0.35)] filter brightness-0 invert" />
                </div>
            ...
            <h2 className="relative text-white text-[24px] font-semibold mb-10 text-center leading-tight z-10 drop-shadow-sm">Bem-vindo de volta</h2>
