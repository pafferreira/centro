...
const Header = ({ title, onBack, showSettings, action }: { title: string; onBack?: () => void; showSettings?: boolean; action?: React.ReactNode }) => (
  <header className="absolute top-0 left-0 right-0 z-30 bg-white/50 backdrop-blur-md px-4 h-16 flex items-center justify-between border-b border-white/20">
...
const BottomNav = ({ active, onChange }: { active: ViewState; onChange: (v: ViewState) => void }) => {
  ...
  return (
    <nav className="absolute bottom-0 left-0 right-0 z-30 bg-white/80 backdrop-blur-xl border-t border-white/60 pb-safe pt-2 px-2 shadow-2xl rounded-t-3xl">
      ...
      <div className="min-h-screen px-6 pt-10 relative z-10">
        ...
        <div className="flex flex-col items-center mb-10">
          <div className="mb-4 drop-shadow-xl">
            <img src="/logo.png" alt="GFA Logo" className="w-48 h-auto object-contain" />
          </div>
  ...
  return (
    <div className="min-h-screen pt-20 px-4 pb-28 bg-gradient-to-br from-white to-blue-50/50">
      ...
      <div className="space-y-6 mt-6">
        ...
        <div className="grid grid-cols-2 gap-4 pt-4 absolute bottom-8 left-4 right-4 bg-white/0">
...
const RoomListView = () => {
  return (
    <div className="min-h-screen pt-24 px-4 pb-28 bg-gradient-to-b from-purple-50 via-white to-green-50">
      <header className="absolute top-0 left-0 right-0 h-20 flex items-end justify-center pb-2 bg-white/80 backdrop-blur-md z-20">
      ...
      <div className="fixed bottom-0 right-0 w-80 h-80 pointer-events-none opacity-[0.03] text-gfa-blue rotate-12 translate-x-1/3 translate-y-1/3">
        <img src="/logo.png" alt="Watermark" className="w-full h-full object-contain opacity-10" />
      </div>
    </div>
  )
}
...
export default function App() {
  ...
  return (
    <div className="font-sans text-text-main selection:bg-primary/20 bg-gray-100 min-h-screen flex justify-center">
      <div className="w-full max-w-md bg-[#f2f5f7] min-h-screen relative shadow-2xl overflow-hidden">
